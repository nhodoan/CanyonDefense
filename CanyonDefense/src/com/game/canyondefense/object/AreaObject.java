...
public class AreaObject {
	...
	case IDObject.START_PLAY:
	    ...
	    myTexture = ManagerRegion.play_game_normal;
	    myTextureWait = ManagerRegion.play_game_press;
	    break;
	...
	case IDObject.PLAY_MENU_SELL:
	    ...
	    height = Dimension.PLAY_MENU_SELL_DEFENSE_H;
	    myTexture = ManagerRegion.sell_normal;
	    myTextureWait = ManagerRegion.sell_press;
	    break;
	    
	case IDObject.PLAY_ATTACK:
	    width = Dimension.PLAY_ATTACK_W;
	    height = Dimension.PLAY_ATTACK_H;
	    myTexture = ManagerRegion.play_attack_new_wave_normal;
	    myTextureWait = ManagerRegion.play_attack_new_wave_press;
	    x = Position.PLAY_ATTACK_X;
	    y = Position.PLAY_ATTACK_Y;
	    break;
	case IDObject.REPLAY:
	    width = Dimension.REPLAY_GAME_W;
	    height = Dimension.REPLAY_GAME_H;
	    myTexture = ManagerRegion.replay_normal;
	    myTextureWait = ManagerRegion.replay_press;
	    x = Position.REPLAY_GAME_X;
	    y = Position.REPLAY_GAME_Y;
	    break;
	case IDObject.BACK_MENU:
	    width = Dimension.BACK_MENU_W;
	    height = Dimension.BACK_MENU_H;
	    myTexture = ManagerRegion.back_menu_normal;
	    myTextureWait = ManagerRegion.back_menu_press;
	    x = Position.BACK_MENU_X;
	    y = Position.BACK_MENU_Y;
	    break;
	    
	case IDObject.CONT_GAME:
	    width = Dimension.CONT_GAME_W;
	    height = Dimension.CONT_GAME_H;
	    myTexture = ManagerRegion.continue_normal;
	    myTextureWait = ManagerRegion.continue_press;
...
//	    myTexture = ManagerRegion.fire_1_normal;
//	    myTextureWait = ManagerRegion.fire_1_press;
//	    break;
...
//	    width = Dimension.FIRE_W;
//	    height = Dimension.FIRE_H;
//	    myTexture = ManagerRegion.fire_2_normal;
//	    myTextureWait = ManagerRegion.fire_2_press;
//	    break;
	}
