...
public class Position {
     ...
     */
    public static float DIFF_EASY_X = width * 70 / 640;
    public static float DIFF_EASY_Y = height * 200 / 360;
    public static float DIFF_NORMAL_X = width * 270 / 640;
    public static float DIFF_NORMAL_Y = height * 200 / 360;
    public static float DIFF_HARD_X = width * 470 / 640;
    public static float DIFF_HARD_Y = height * 200 / 360;
